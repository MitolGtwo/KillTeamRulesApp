...
val XV26Lodestar = Operative(
    name = "XV26 Lodestar",
    imageRes = R.drawable.xv26_lodestar,
    ...
    abilities = listOf(
        Ability(
            title = "Electrochaff Launcher",
            usage = R.string.electro_launcher_usage,
            description = R.string.electro_launcher_description
        ),
        Ability(
            title = "Homing Beacon",
            usage = R.string.homing_beacon_usage,
            description = R.string.homing_beacon_description
        )
    ),
