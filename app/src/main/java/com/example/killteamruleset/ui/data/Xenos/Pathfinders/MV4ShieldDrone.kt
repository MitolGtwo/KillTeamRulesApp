...
val Mv4ShieldDrone = Operative(
    name = "Mv4 Shield Drone",
    imageRes = R.drawable.path_shielddrone,
    ...
    abilities = listOf(
        ...
        Ability(
            ...
            usage = R.string.path_shieldgenerator_usage,
            description = R.string.path_shieldgenerator_description
        )
    ),
