...
val KasrkinReconTrooper = Operative(
    ...
    abilities = listOf(
        Ability(
            title = "Reconnoitre Killzone",
            usage = R.string.reconnoitre_killzone_usage,
            description = R.string.reconnoitre_killzone_description
        ),
        Ability(
            title = "Auspex Scan",
