...
val XV26Neutraliser = Operative(
    name = "XV26 Neutraliser",
    imageRes = R.drawable.xv26_neutraliser,
    ...
    abilities = listOf(
        Ability(
            title = "Multispectrum Sensor Package",
            usage = R.string.xvspectrum_usage,
            description = R.string.xvspectrum_description
        ),
        Ability(
            title = "System Jam",
            usage = R.string.xv_jam_usage,
            description = R.string.xv_jam_description
        )
    ),
