...
val TranspectralInterferencePathfinder = Operative(
    ...
    abilities = listOf(
        Ability(
            ...
            usage = R.string.multi_dimensiona_vision_usage,
            description = R.string.multi_dimensiona_vision_description
        ),
        Ability(
            title = "System Jam",
            usage = R.string.path_systemjam_usage,
            description = R.string.path_systemjam_description
        ),
        Ability(
            title = "Markerlight",
