...
val HearthkynWarrior = Operative(
    name = "Hearthkyn Warrior",
    imageRes = R.drawable.salvagers_warrior,
    ...
    abilities = listOf(
        Ability(
            title = "Secure Salvage",
            usage = R.string.secure_salvage_usage,
            description = R.string.secure_salvage_description
        )
    ),
