...
val AssaultGrenadierPathfinder = Operative(
    name = "Assault Grenadier Pathfinder",
    imageRes = R.drawable.path_grenadier,
    ...
    abilities = listOf(
        Ability(
            title = "Grenadier Specialist",
            usage = R.string.grenadier_specialist_usage,
            description = R.string.grenadier_specialist_description
        ),
        Ability(
            title = "Markerlight",
