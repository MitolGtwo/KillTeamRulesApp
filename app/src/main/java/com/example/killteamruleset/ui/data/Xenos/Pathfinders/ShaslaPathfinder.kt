...
val ShaslarPathfinder = Operative(
    ...
    abilities = listOf(
        Ability(
            ...
            usage = R.string.path_group_activation_usage,
            description = R.string.path_group_activation_description
        ),
        Ability(
            title = "Fearless on the Frontline",
            usage = R.string.fearless_fronliner_usage,
            description = R.string.fearless_fronliner_description
        ),
        Ability(
            title = "Markerlight",
