...
val RavenerWarrior = Operative(
    name = "Ravener Warrior",
    imageRes = R.drawable.ravener_warrior,
    ...
    abilities = listOf(
        Ability(
            ...
            usage = R.string.instictive_behaviour_usage,
            description = R.string.instictive_behaviour_description
        ),
    ),
